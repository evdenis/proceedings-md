...
ispras_templates:
  ...
  authors:
    - name_ru: 'И.И. Иванов'
      ...
      details_ru: >-
        Иван Иванович ИВАНОВ – кандидат технических наук, профессор, заведующий
        ...
        защиты информации.
      details_en: >-
        Ivan Ivanovich IVANOV – Cand. Sci. (Tech.), Professor, Head
    ...
    - name_ru: 'П.П. Петров'
      ...
      details_ru: >-
        ...
        М.В. Ломоносова, доктор физико-математических наук. Его научные интересы
        включают распознавание образов, системы остаточных классов.
      details_en: >-
        Petr Petrovich PETROV – Dr. Sci. (Phys.-Math,), specialist of the Department of system
  ...
  abstract_ru: >-
    ...
    определены в таблице стилей. Примеры Вы можете видеть в оформлении этого шаблона.
    Красным цветом указан стиль оформления каждого компонента и пояснения к нему.
  abstract_en: >-
  ...
  keywords_ru: 'список ключевых слов, разделенных точкой с запятой; число
    позиций в этом списке и в списке на английском языке должно быть одинаковым.'
...
публиковавшиеся в других изданиях и в глобальной информационной сети. Объем публикуемых статей, как
правило, не должен быть меньше 8-9 страниц и не превышать 20 страниц.
...
-   информация об авторах (заголовок «Информация об авторах / Information about
    authors»).
...
2.  основной шрифт для заголовков -- Arial;
3.  междустрочный интервал -- одинарный;
4.  основной размер шрифта -- 10 пт.;
5.  отступы абзаца («до» и «после») 1,5 пт., абзацы не разделяются пустой строкой;
6.  выравнивание «по ширине».

#### 2.1.1 Заголовки уровней 1 и 2

Заголовок статьи (заголовок первого уровня) вводится полужирным шрифтом
Arial размера 16 пт. Задается выравнивание по центру. Отступы абзаца: «до» 48 пт., «после» 24 пт.
...
и т.д.) и не выравниваются. Отступы абзаца: «до» 12 пт., «после» 3 пт.

#### 2.1.2 Заголовки уровней 3 и 4
...
конце номера (1.1, 1.1.2 и т.д.) и не выравниваются.
Отступы абзаца: «до» 12 пт., «после» 3 пт.

#### 2.1.3 Заголовки уровней 5 и более высоких
...
Отступы абзаца: «до» и «после» 6 пт.
...
JPEG, GIF, PNG) и иметь достаточно высокое качество (разрешение не менее 300 dpi). Если таких файлов
...
#### 2.4.1 Надписи на рисунках

Надписи на рисунке по возможности должны быть на русском и английском
языках.

#### 2.4.2 Подписи под рисунками

Подрисуночные подписи должны быть на двух языках и начинаться с
...
выравнивается. Ссылки на рисунки и таблицы в тексте статьи должны иметь вид
\"рис. 1\" и \"табл. 1\" соответственно.
